...
# New, direct download link to aarch64 binary
DOWNLOAD_URL="https://github.com/Cj-bc/Stockfish-ARM/releases/download/15.1-arm/stockfish-armv8-aarch64"

echo "--- Downloading and installing Stockfish for ARM aarch64 (v3) ---"
